MESSAGES = {
    ...
    "wizard.step5.kv_create": "正在创建 KV 命名空间 {title}...",
    "wizard.step5.kv_exists": "\n[!] 你的 Cloudflare 账号中已存在名为 '{title}' 的 KV 命名空间。",
    "wizard.step5.how_to_proceed": "你想如何继续？",
    "wizard.step5.kv_action.options": ["复用现有 KV (重新安装或升级时推荐)", "创建一个新的且名称唯一的 KV", "中止部署"],
    "wizard.step5.kv_new_name": "输入新的 KV 名称 (例如 QM_RELAY_ALERTS)",
