MESSAGES = {
    ...
    "wizard.step5.kv_create": "Creating KV namespace {title}...",
    "wizard.step5.kv_exists": "\n[!] A KV namespace named '{title}' already exists in your Cloudflare account.",
    "wizard.step5.how_to_proceed": "How would you like to proceed?",
    "wizard.step5.kv_action.options": ["Reuse existing KV (Recommended if reinstalling)", "Create a new KV with a unique name", "Abort deployment"],
    "wizard.step5.kv_new_name": "Enter new KV title (e.g. QM_RELAY_ALERTS)",
